        ...
        <tbody>
            <?php
                ...
                foreach($client_quote as $c){ //Array ( [clientID] => 1 [client_name] => dsa [address] => dsa [contact_no] => 123 ) 
                    ...
                    .'</td><td><a href="" class="btn btn-danger btn-xs"><i class="fa fa-thumbs-up"></i> Purchase</a></td></tr>';
        ...
        <tbody>
            <?php
                ...
                foreach($orders as $c){ //Array ( [clientID] => 1 [client_name] => dsa [address] => dsa [contact_no] => 123 ) 
                    echo "<tr><td>".$c['orderID']."</td><td>".$c['clientID']."</td><td>".$c['date']."</td><td>".$c['time']."</td><td>".$c['due']
