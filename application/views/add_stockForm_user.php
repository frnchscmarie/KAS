...
<div class="tab-content">
  ...
  <?php echo form_open('SalesAgent/addStocks','id="stocks"'); //this is equal to <form method="post" accept-charset="utf-8" action="http://localhost/SalesAgent-Auto-Supply/SalesAgent/addItem">
