...
class SalesAgent extends CI_Controller {
    ...
    public function viewQuote($quoteID){
        ...
        if($this->form_validation->run()==FALSE){
            ...
            $this->load->view('include/SA_header',$title);
            $this->load->view('quote_view_user',$data);
            $this->load->view('include/footer');
        }
        else{
         $last=$this->Order->count();
    ...
    public function addQuote(){ 
     ...
     /*$rules = array(
        ...
        if($this->form_validation->run()==FALSE){*/
            ...
            $data['items'] = $result_array;
            $this->load->view('include/SA_header',$header_data);
            $this->load->view('add_quote_user',$data);
            $this->load->view('include/footer');
        //}
       // else{
            $count = 0; 
    ...
    $rules = array(
        ...
        if($this->form_validation->run()==FALSE){
            ...
            $data['items'] = $result_array;
            $this->load->view('include/SA_header',$header_data);
            $this->load->view('add_purchased_user',$data);
            $this->load->view('include/footer');
            }
            else{
            $data['quoteID'] = NULL;
    ...
    public function returnItem($orderID){
       /** $rules = array(
        ...
        if($this->form_validation->run()==FALSE){**/
            ...
            $this->load->view('include/SA_header',$header_data);
            $this->load->view('return_view_user',$data);  
       //  }
        //else{
        $count = 0; 
             if(!empty($_POST['itemList'])) {
    ...
    public function viewTransaction($orderID){
        ...
        $this->load->view('include/SA_header',$header_data);
        $this->load->view('order_details_view_user',$data);
        $this->load->view('include/footer');
    }
    ...
    public function updateTransaction($transID){
        ...
        if($this->form_validation->run()==FALSE){
            ...
            $this->load->view('include/SA_header',$header_data);
            $this->load->view('update_transForm_user',$data);
            $this->load->view('include/footer');
        }
        else{
    ...
    public function updateDeliveryStatus($statusID, $orderID){
        ...
        if($this->form_validation->run()==false){
            ...
            $this->load->view('include/SA_header',$header_data);
            $this->load->view('update_DeliveryStatus_user',$data);
            $this->load->view('include/footer');
        }
        else{
    ...
    public function addStocks(){
       ...
       $rules = array(
        ...
        if($this->form_validation->run()==FALSE){
            ...
            $data['items'] = $result_array;
            $this->load->view('include/SA_header',$header_data);
            $this->load->view('add_stockForm_user',$data);
            $this->load->view('include/footer');
        }
     else{
             if(!empty($_POST['itemList'])) {
